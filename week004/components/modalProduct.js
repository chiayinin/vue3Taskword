   ...
   <div class="modal-body">
     <div class="row">
       <div class="col-sm-4">
         ...
         <div>
           <button class="btn btn-outline-primary btn-sm d-block w-100 mb-2" @click="tempProduct.imageUrl = tempProduct.imageUrl">
             新增圖片
           </button>
         </div>
         <div>
           <button class="btn btn-outline-danger btn-sm d-block w-100 mb-5" @click="tempProduct.imageUrl = '' ">
             刪除圖片
           </button>
         </div>
         <div class="mb-3">
           ...
           <div v-if="Array.isArray(tempProduct.imagesUrl)">
             <template v-for="(item, key) in tempProduct.imagesUrl" :key="key + '1234'">
               <input type="text" class="form-control mb-2" placeholder="請輸入圖片連結" id="imagesUrl" v-model="tempProduct.imagesUrl[key]">
             ...
             <button v-else type="button" class="btn btn-outline-danger btn-sm d-block w-100" @click="tempProduct.imagesUrl.splice(-2,1)('')">
               刪除最後一張圖片
             </button>
           </div>
         </div>
